function makeBigger() {
   ...
   document.querySelector('h1, #content').style.fontSize="100px";
   document.querySelector('div.content').style.fontSize="100px";
};

function makeSmaller() {
   document.querySelector('h1').style.fontSize="1px";
   document.querySelector('div.content').style.fontSize="1px";
};
